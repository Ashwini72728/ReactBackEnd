...
public class PersonalInfoCache {
	...
	public PersonalInfoCache() {
		
	}

	
	public PersonalInfoCache(int personalId, int userId, int roleId, String firstName, String middleName,
			String lastName, String gender, Timestamp dob, int age, String address, String city, String state,
			int pinCode, Long mobileNo, String physicalDisability, String maritalStatus, String educationalStatus,
			String birthSign, boolean approved, String email) {
		super();
	...
	public String toString() {
		return "PersonalInfoCache [personalId=" + personalId + ", userId=" + userId + ", roleId=" + roleId
				...
				+ ", birthSign=" + birthSign + ", approved=" + approved + ", email=" + email + "]";
	}
